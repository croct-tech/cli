...
export class FileSystemTsConfigLoader implements TsConfigLoader {
        ...
        if (config?.extends !== undefined) {
            ...
            if (parentPath !== null) {
                ...
                if (parentConfig !== null) {
                    config = FileSystemTsConfigLoader.mergeConfig(config, parentConfig);
                }
            }
        }
                ...
                for (const targetDirectory of targetDirectories) {
                    ...
                    for (const include of referenceConfig.include) {
                        ...
                        if (minimatch.match(relativeTargetDirectory)) {
                            return FileSystemTsConfigLoader.mergeConfig(
                                {
                                    ...referenceConfig,
                                    rootConfigPath: config.rootConfigPath,
                                },
